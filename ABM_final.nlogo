  ...
  ask turtles [ ;asks all turtles to review posts
    foreach posters [ ;for every post
      x -> if x != self [ ; makes the poster x for further coding and makes sure noone likes their own posts cause that is cringe fam
        ...
        [
          if random 900  < ([pervasiveness] of x * similarity) / (trait-similarity / 3) ; the test for liking a post of someone you don't follow, the same calculation except there is a lower chance of succeess
          [ask x [set post-likes post-likes + 1] ;updates the post likes of the poster if post is liked
            liked-post] ;this is a function which updates the traits of the agent liking the post
          if random 1100 < round ([pervasiveness] of x * similarity) / (trait-similarity / 3) and trait-similarity < 13 [ ; the test for following someone a calculation is made based on poster pervasiveness and similarity between the agents and the agents must be fairly similar
              create-link-to x]
          ]
        ]
      ]
...
to get-pervasiveness ;updates pervasiveness based on followers
  ...
  ask turtles[
    ...
    set pervasiveness o-pervasiveness * 1.5
  ]
    if (followers - (count links / count turtles)) / calculation-sd > 0.5 and (followers - (count links / count turtles)) / calculation-sd < 2 [ ; sets every agent with a follower count exceeding one standard deviation from the mean amount of followers pervasiveness to 160% of their original pervasiveness
     set pervasiveness o-pervasiveness * 0.8
    ]
            if (followers - (count links / count turtles)) / calculation-sd > 0 and (followers - (count links / count turtles)) / calculation-sd < 0.5 [ ;sets every agent with a follower count between -0.5 and 0.5 standard deviations under the mean to 60 % of their original pervasiveness
      set pervasiveness o-pervasiveness * 0.5
        ]
        if (followers - (count links / count turtles)) / calculation-sd > -0.5 and (followers - (count links / count turtles)) / calculation-sd < 0 [ ;sets every agent with a follower count between -0.5 and 0.5 standard deviations under the mean to 60 % of their original pervasiveness
      set pervasiveness o-pervasiveness * 0.35
    ]
    if (followers - (count links / count turtles)) / calculation-sd > -1.5 and (followers - (count links / count turtles)) / calculation-sd < -0.5 [ ;sets every agent with a follower count between -0.5 and 0.5 standard deviations under the mean to 60 % of their original pervasiveness
      set pervasiveness o-pervasiveness * 0.34
    ]
    if (followers - (count links / count turtles)) / calculation-sd > -2 and (followers - (count links / count turtles)) / calculation-sd < -1.5[ ;sets every agent with a follower count exceeding minus one standard deviation from the mean amount of followers pervasiveness to 40% of their original pervasiveness
     set pervasiveness o-pervasiveness * 0.25
        ]
      if (followers - (count links / count turtles)) / calculation-sd < -2[ ;sets every agent with a follower count exceeding minus two standard deviation from the mean amount of followers pervasiveness to 20% of their original pervasiveness
        set pervasiveness pervasiveness * 0.1]
  ]
  ]
  ]
